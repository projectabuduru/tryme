...
<body>
    ...
    <div class="main-wrapper">
        ...
        <div class="hero-slider hero-slider-one">
            ...
            <!-- Single Slide Start -->
            <div class="single-slide" style="background-image: url(<?php echo base_url('assets/images/slider/slide-bg-1.jpg');?>)">
            ...
            <!-- Single Slide Start -->
            <div class="single-slide" style="background-image: url(<?php echo base_url('assets/images/slider/slide-bg-3.jpg');?>)">
                <!-- Hero Content One Start -->
                <div class="hero-content-one container">
                    <div class="row">
                        <div class="col-lg-10 col-md-10">
            ...
            <div class="container">
                ...
                <div class="row product-active-lg-4">
                    ...
                    <div class="col-lg-3">
                        ...
                        <div class="single-product-wrap">
                            <div class="product-image">
                                <a href="product-details.html"><img src="<?php echo base_url('assets/images/product/product-01.jpg');?>" alt="Produce Images"></a>
                    ...
                    <div class="col-lg-3">
                        ...
                        <div class="single-product-wrap">
                            <div class="product-image">
                                <a href="product-details.html"><img src="<?php echo base_url('assets/images/product/product-02.jpg');?>" alt="Produce Images"></a>
                    ...
                    <div class="col-lg-3">
                        ...
                        <div class="single-product-wrap">
                            <div class="product-image">
                                <a href="product-details.html"><img src="<?php echo base_url('assets/images/product/product-03.jpg');?>" alt="Produce Images"></a>
                                <div class="product-action">
                                    <a href="#" class="add-to-cart"><i class="ion-bag"></i></a>
                                    <a href="#" class="wishlist"><i class="ion-android-favorite-outline"></i></a>
                                    <a href="#" class="quick-view" data-toggle="modal" data-target="#exampleModalCenter"><i class="ion-ios-search"></i></a>
                    ...
                    <div class="col-lg-3">
                        ...
                        <div class="single-product-wrap">
                            <div class="product-image">
                                <a href="product-details.html"><img src="<?php echo base_url('assets/images/product/product-04.jpg');?>" alt="Produce Images"></a>
                                <span class="label">30% Off</span>
                                <div class="product-action">
                                    <a href="#" class="add-to-cart"><i class="ion-bag"></i></a>
                                    <a href="#" class="wishlist"><i class="ion-android-favorite-outline"></i></a>
                    ...
                    <div class="col-lg-3">
                        ...
                        <div class="single-product-wrap">
                            <div class="product-image">
                                <a href="product-details.html"><img src="<?php echo base_url('assets/images/product/product-06.jpg');?>" alt="Produce Images"></a>
                                <span class="label">30% Off</span>
                                <div class="product-action">
                                    <a href="#" class="add-to-cart"><i class="ion-bag"></i></a>
                                    <a href="#" class="wishlist"><i class="ion-android-favorite-outline"></i></a>
            ...
            <div class="container">
                ...
                <div class="row product-two-row-4">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="single-product-wrap">
                            <div class="product-image">
                                <a href="product-details.html"><img src="<?php echo base_url('assets/images/product/product-09.jpg');?>" alt="Produce Images"></a>
                                <span class="label">30% Off</span>
                                <div class="product-action">
                                    <a href="#" class="add-to-cart"><i class="ion-bag"></i></a>
                                    <a href="#" class="wishlist"><i class="ion-android-favorite-outline"></i></a>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="single-product-wrap">
                            <div class="product-image">
                                <a href="product-details.html"><img src="<?php echo base_url('assets/images/product/product-10.jpg');?>" alt="Produce Images"></a>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="single-product-wrap">
                            <div class="product-image">
                                <a href="product-details.html"><img src="<?php echo base_url('assets/images/product/product-11.jpg');?>" alt="Produce Images"></a>
                                <span class="label">30% Off</span>
                                <div class="product-action">
                                    <a href="#" class="add-to-cart"><i class="ion-bag"></i></a>
                                    <a href="#" class="wishlist"><i class="ion-android-favorite-outline"></i></a>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="single-product-wrap">
                            <div class="product-image">
                                <a href="product-details.html"><img src="<?php echo base_url('assets/images/product/product-12.jpg');?>" alt="Produce Images"></a>
                                <span class="label">30% Off</span>
                                <div class="product-action">
                                    <a href="#" class="add-to-cart"><i class="ion-bag"></i></a>
                                    <a href="#" class="wishlist"><i class="ion-android-favorite-outline"></i></a>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="single-product-wrap">
                            <div class="product-image">
                                <a href="product-details.html"><img src="<?php echo base_url('assets/images/product/product-05.jpg');?>" alt="Produce Images"></a>
                                <span class="label">30% Off</span>
                                <div class="product-action">
                                    <a href="#" class="add-to-cart"><i class="ion-bag"></i></a>
                                    <a href="#" class="wishlist"><i class="ion-android-favorite-outline"></i></a>
