...
class Admin extends CI_Controller {
    ...
    function get_all_admin(){
        ...
        $this->db->where_in('role', array('admin', 'super_admin'));
	...
	public function modaladmin() {
		$this->load->view('modal/admin',null,FALSE);
	}

	public function modal_update_admin($id) {
        $this->db->where('user_id', $id);
		$admin = $this->db->get('user')->row();
        $data['admin']    = $admin;
		$this->load->view('modal/admin',$data,FALSE);
    }
	...
	public function create_admin() {
        ...
        $this->db->insert_id();
        echo json_encode(array("status" => TRUE,'msg'=>'Insert Data Admin Berhasil'));
	}
